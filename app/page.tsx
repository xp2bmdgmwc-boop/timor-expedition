...
export default function TimorHomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] text-[#0E0E0C]">
      ...
      {/* Плавающий значок WhatsApp справа внизу */}
      <aside aria-label="Прямая связь в WhatsApp" className="fixed bottom-6 right-6 z-50">
        <a
          href={whatsappUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 px-5 py-3.5 bg-[#25D366] hover:bg-[#20bd5a] text-black text-[12px] font-bold tracking-[0.14em] uppercase transition-all duration-200 shadow-2xl border border-black/10 group"
